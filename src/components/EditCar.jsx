...
function EditCar(carro) {
    ...
    // const saveAdd = () => {
    //     MySwal.fire("El vehiculo fue agregado satisfactoriamente", "", "success");
    // }

    const idmodal = `#${carro.carModel}`;
    const idmodal2 = `${carro.carModel}`;
    console.log(idmodal);
    console.log(idmodal2);

  return (
    <>
<button className="btn btn-warning" data-bs-toggle="modal" data-bs-target={idmodal} title="Modificar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16">
